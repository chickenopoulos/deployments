"""Bottom-quintile 60/14 overnight continuation of the Concretum daily analog.

Lab run: thequantgpt-wrapper/runs/etf_concretum_tf_rank
Mapping A, after US cash close. Contrast only — OOS ranking reversed on the analog.
"""
...
RUN_FREQUENCY = "1d"
NAME = "ETF49 Concretum analog overnight, bottom quintile 60/14"
BOOK = "bottom"
